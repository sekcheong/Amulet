...
Am_Object Name_And_Label_Window_Initialize () {
  Name_And_Label_Window = Am_Window.Create("Name_And_Label_Window")
    .Set(Am_DESTROY_WINDOW_METHOD, Am_Default_Pop_Up_Window_Destroy_Method)
    .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
    .Set(Am_TITLE, "Name and Label Setting")
    .Set(Am_ICON_TITLE, "Settings: Name and Label")
    .Set(Am_WIDTH, 389)
    .Set(Am_HEIGHT, 132)
